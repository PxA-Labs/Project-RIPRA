...
We as members, contributors, and leaders of Project RIPRA pledge to make
...
diverse, inclusive, and healthy community focused on advancing adaptive
optics research and real-time wavefront reconstruction tooling.
...
* Focusing on what is best not just for us as individuals, but for the
  overall community and the scientific integrity of the project
...
* Misrepresenting research results, fabricating data, or plagiarizing the
  work of others
...
requests, discussions, commit messages) associated with this repository,
and also applies when an individual is officially representing the project
in public spaces, such as conferences, hackathon submissions, or associated
publications.
...
GitHub (using the repository's "Report content" option) or by contacting
the maintainers directly through the contact listed in the repository's
